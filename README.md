# Template Retail Shopping Cart Process API
...
The API provides endpoints for saving to the shopping cart, updating, deleting and obtaining shopping cart. The details about content of shopping cart is fetch from Product Availability Process API. 
...
+ product-availability-process-api.host `product.availability.example.com`
